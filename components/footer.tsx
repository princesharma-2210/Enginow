    ...
    <footer className="w-full bg-gradient-mesh border-t border-white/20">
      <div className="container py-12 md:py-16">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-6 lg:grid-cols-12">
          ...
          <AnimatedElement animation="fade-up" delay={0.2} className="md:col-span-1 lg:col-span-2">
            ...
            <ul className="space-y-3 text-sm">
              {[
                ...
                <li key={i}>
                  <Link href={link.href} className="text-muted-foreground hover:text-primary transition-colors flex items-center">
                    <ArrowRight className="h-3 w-3 mr-2" /> {link.name}
                  </Link>
                </li>
              ))}
            </ul>
          ...
          <AnimatedElement animation="fade-up" delay={0.3} className="md:col-span-1 lg:col-span-2">
            ...
            <ul className="space-y-3 text-sm">
              {[
                ...
                <li key={i}>
                  <Link href={link.href} className="text-muted-foreground hover:text-secondary transition-colors flex items-center">
                    <ArrowRight className="h-3 w-3 mr-2" /> {link.name}
                  </Link>
                </li>
              ))}
          ...
          {/* Footer Bottom */}
          <AnimatedElement animation="fade-up" delay={0.6} className="mt-12 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-6 text-xs font-bold">
              {[
                ...
                { name: "Refund Policy", href: "/refundpolicy" }, //add right now by prince sharma
              ].map((link, i) => (
